...
screen's status lines — reads English, Spanish or Korean. Each person picks theirs next to their address
...
A facilitator reading the queue in Spanish or Korean still sees English topic labels. That is deliberate —
