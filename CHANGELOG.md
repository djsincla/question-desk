...
### Fixed
- A small grey scrollbar showed at the right end of the Admin page's tabs in browsers set to
  always show scrollbars. The tab row still scrolls sideways on narrow screens.
