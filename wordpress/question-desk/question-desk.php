...
require_once QD_DIR . 'includes/class-qd-moderation.php';
require_once QD_DIR . 'includes/class-qd-coordinator.php';
require_once QD_DIR . 'includes/class-qd-gemini.php';
require_once QD_DIR . 'includes/class-qd-schedule.php';
require_once QD_DIR . 'includes/class-qd-summaries.php';
